...
.nav-bar{position:fixed;top:0;left:0;right:0;z-index:9999;display:flex;align-items:center;
  justify-content:space-between;padding:0 2.5rem;height:50px;
  background:rgba(51, 6, 54,0.92);backdrop-filter:blur(16px);
...
.nav-links a{color:#bbb;text-decoration:none;font-size:1.1rem;font-weight:500;
